...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    ...
    final lightTheme = buildAloeTheme(Brightness.light, desktop: themeProvider.pcMode);
    final darkTheme = buildAloeTheme(Brightness.dark, desktop: themeProvider.pcMode);
