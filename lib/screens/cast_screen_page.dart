...
Widget build(BuildContext context) {
  ...
  // 主题适配色彩
  final primaryColor = isDarkMode ? Colors.blue.shade300 : Colors.blue.shade600;
                  ...
                  builder: (context, snapshot) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final isSelected = _selectedDevice?.device.spec.udn == device.device.spec.udn;
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  device.device.spec.friendlyName,
                                                  style: TextStyle(
                                                    fontSize: 16,
                                                    fontWeight: FontWeight.bold,
                                                    color: textColor,
