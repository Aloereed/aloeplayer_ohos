...
class PlaybackMedia {
  ...
  const PlaybackMedia({required this.id, required this.url, required this.title, this.modified, this.subtitles = const []});
  ...
  static bool isRemote(String id) => Uri.tryParse(id)?.scheme == 'aloe-media';
