...
后端仓库 `E:\source\wp-ucenter-py`，实现提交 `55cc1bd`。
客户端继续使用里程碑 39（3.1.1+183），本次不需要重新安装 HAP。

更新包：`build/backend-milestones/01-iap-renewal-notifications/ucenter-iap-notifications-update.zip`。
